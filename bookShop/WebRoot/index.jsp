				...
				<div id="shopMath">
					<div class="shopDetail" id="math">
						<dl class="shopDetail_item" >
							<dt><a href="数学">数学</a><span class="badge hot pull-right"> HOT</span><img class="jiantou" src="img/icon/jiantou.jpg" height="8" width="5"></dt>
...
<!--
{$smarty.session.name}用户名（可判断其是否为空来判断有无登录）
{$smarty.session.id}未决定
{$fail}登录失败时传出的参数
{$password}密码，可选用
-->
